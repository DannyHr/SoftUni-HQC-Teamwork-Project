namespace RestSharp.Authenticators.OAuth
{
    ...
    internal class OAuthWorkflow
    {
        ...
        public virtual OAuthWebQueryInfo BuildRequestTokenInfo(string method, WebParameterCollection parameters)
        {
            ...
            var signatureBase = OAuthTools.ConcatenateRequestElements(method, this.RequestTokenUrl, parameters);
            var signature = OAuthTools.GetSignature(this.SignatureMethod, this.SignatureTreatment, signatureBase, this.ConsumerSecret);
            ...
            var info = new OAuthWebQueryInfo
            {
                ...
                Callback = OAuthTools.UrlEncodeRelaxed(this.CallbackUrl ?? string.Empty),
        ...
        public virtual OAuthWebQueryInfo BuildProtectedResourceInfo(string method, WebParameterCollection parameters, string url)
        {
            ...
            var signature = OAuthTools.GetSignature(
                this.SignatureMethod, this.SignatureTreatment, signatureBase, this.ConsumerSecret, this.TokenSecret);
